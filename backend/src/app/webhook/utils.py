...
from app.infrastructure.database.setup import create_session_pool, create_engine
from app.config import tgbot_config, db_config
...
def validate_telegram_data(init_data: str) -> bool:
    ...
    secret_key = hmac.new(
        b"WebAppData", tgbot_config.token.encode(), hashlib.sha256
    ).digest()
